...
Many thanks to the [Python Chinese Community](https://blog.csdn.net/BF02jgtRS00XKtCx/article/details/79547627) for releasing the source code `SourceCode_weibocrawler.py`.
