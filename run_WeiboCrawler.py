...
for cards in list_cards:
    ...
    for card in cards:
        ...
        if card['card_type'] == 9:
            ...
            # 4.3 Crawl videos.
            # 4.3.1 Crawl video in original post.
            if 'page_info' in card['mblog']:
                if 'media_info' in card['mblog']['page_info']:
                    ...
                    video_url = card['mblog']['page_info']['media_info']['mp4_sd_url']  # <str>
                    # Note:
            ...
            # 4.3.2 Crawl video in re-tweeted post.
            if 'retweeted_status' in card['mblog']:
                if 'page_info' in card['mblog']['retweeted_status']:
                    if 'media_info' in card['mblog']['retweeted_status']['page_info']:
                        # Note:
                        #     Only video post (re-tweeted) has '['retweeted_status']['page_info']['media_info']'.
                        #     Each video post has one video and no image.
                        ...
                        video_url = card['mblog']['retweeted_status']['page_info']['media_info']['mp4_sd_url']  # <str>
                        # Note:
                        #     The code returns the video URL of current post.
                        #     The index of 'card' is parsed from DevTools.
