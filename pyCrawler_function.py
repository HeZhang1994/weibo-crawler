...
def time_str2float(timestamp):
    ...
    Parameter:
        timestamp <str> - The string of timestamp formatted as 'hh:mm:ss.nnn'.

    Return:
        time_num <float> - The floating number of timestamp formatted as 'ss.nnn'.
    '''
...
def get_video_duration(path_video):
    ...
    Return:
        duration <str> - The duration of video formatted as 'hh:mm:ss.nnn'.
    '''
...
def resize_image(path_image, ratio=0.4):
    ...
    Parameters:
        ...
        ratio <float> - The resizing ratio of image. Default is '0.4'.
...
def crawl_image(txt_file, image_path, image_urls, image_frmt='.jpg'):
    ...
    Parameters:
        ...
        image_frmt <str> - The format of images.
...
def crawl_livephoto(txt_file, photo_path, photo_urls, if_live2gif):
    ...
    Parameters:
        ...
        if_live2gif <int> - If convert photos (videos) to GIF images.
    ...
    for i in range(len(photo_urls)):
        # Save the URL of live photos to TXT file.
        with open(txt_file, 'a', encoding='utf-8') as ff:
        ...
        # Convert live photo (video) to GIF image.
        if os.path.isfile(path) and if_live2gif == 1:
...
def crawl_video(txt_file, video_path, video_url, video_frmt='.mp4'):
    ...
    Parameters:
        ...
        video_url <str> - The URL of video.
        video_frmt <str> - The format of video.
